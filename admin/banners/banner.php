...
<h2 class="mb-0 text-center h1 text-primary uppercase">Active Banners</h2>
<hr>
<div class="row">
    <?php
    if($banners!=NULL)
    ...
    <div class="col-12 col-lg-6 col-xl-6" >
        <div class="card">
            <img src="<?php echo "../files/banners/".$banner['image_name']; ?>" height="300"  class="card-img-top" alt="">
            <div class="card-body">
                <hr>
                <div class="profile-social mt-3 text-right">
                    ...
                    <a data-toggle="popover"  data-trigger="hover" data-original-title="View Banner Details" class="btn btn-linkedin text-center bg-success bg-darken-2  text-white  float-left" ><i class="fa fa-eye "></i></a>
                    </span>
                    <span  onclick="edit('<?php echo $banner['id']; ?>','<?php echo $banner['title']; ?>','<?php echo $banner['description']; ?>','<?php echo $banner['status']; ?>')">
                    <a  data-toggle="popover"  data-trigger="hover" data-original-title="Edit Banner" class="btn btn-linkedin " ><i class="bx bx-edit"></i></a>
                    </span>
                    <span  onclick="delete_banner('<?php echo $banner['id']; ?>')">
                    <a class="btn btn-pinterest " data-toggle="popover"  data-trigger="hover" data-original-title="Delete Banner"><i class="bx bx-trash"></i></a>
                    </span>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content radius-30">
            <div class="modal-header bg-primary bg-darken-2 border-bottom-0">
                <h3 class="text-white m-1">Add Banner</h3>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title  my-1" >View Banner Details</h4>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content radius-30">
            <div class="modal-header bg-info border-bottom-0">
                <h4 class="modal-title my-1" >Edit Banner</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body p-5">
                ...
                <form action="../action.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="h4">Description</label>
                        <textarea class="ckeditor form-control form-control-lg radius-30" id="edit_description" name="edit_description" ><?php echo $banner['description']; ?></textarea>
                    </div>

                    <input type="text" id="edit_id" name="edit_id" value="" hidden>
                    <hr/>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary float-right  btn-lg " name="edit_banner">Update Banner</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content  border-0">
            <div class="modal-header bg-danger bg-darken-2 border-bottom-0">
                <h5 class="modal-title" style="color:white;">Delete Banner</h5>
            ...
            <div class="modal-body">
                <form action="../action.php" method="POST">
                    ...
                    <div class="modal-footer border-top-0">
                        ...
                        <button type="submit" name="delete_banner" class="btn btn-outline-danger">Delete</button>
                    </div>
                </form>
            </div>
