        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                        <a class="dropdown-item" href="user_profile.php"><i class="mr-1 fas fa-user-cog"></i>Profile</a>
                        <!--                            <a class="dropdown-item" href="user_profile.php"><i class="mr-1 fas fa-cog"></i>Settings</a>-->
                        <a class="dropdown-item" href="../action.php?logout=true"><i class="mr-1  fas fa-sign-in-alt"></i> Logout</a>
                    </div>
                </li>
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="../dashboard.php">
                        <span class="brand-logo">
                            <img src="../../assets/header_logo-removebg-preview-removebg-preview.png" style="max-width: 81px;"></span>
...
-->
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="../newsletter.php"><i class="bx bx-star"></i><span class="menu-title text-truncate " data-i18n="Email">Newsletter</span></a> </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="../terms.php"><i class="fas fa-file-alt "></i><span class="menu-title text-truncate" data-i18n="Kanban">Terms and Privacy</span></a> </li>
