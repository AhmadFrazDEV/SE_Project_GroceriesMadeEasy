...
$query = "SELECT * from discount_banner";
                    ...
                    <div class="d-flex justify-content-between breadcrumb-wrapper">
                        <nav aria-label="breadcrumb ">
                            <ol class="breadcrumb mt-2">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Discount Banners </a></li>
                            </ol>
                        </nav>
                        <nav aria-label="breadcrumb ">
                            <div class="ml-auto">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-success bg-success bg-darken-2 m-1 px-5" data-toggle="modal" data-target="#add_banner"><i class="bx bx-image-add mr-1"></i>Add Discount Banner</button>
                                </div>
                            </div>
                        </nav>
                    </div>
...
<h2 class="mb-0 text-center h1 text-primary uppercase">Discount Banners </h2>
<hr>
<div class="row">
    <?php
    if($banners!=NULL)
    ...
    <div class="col-12 col-lg-6 col-xl-4">
        <div class="card">
            <img src="<?php echo "../files/banners/".$banner['image_name']; ?>" class="w-100 card-img-top mb-3" alt="">
            <div class="card-body">
                <hr>
        ...
        <div class="modal-content radius-30">
            ...
            <div class="modal-body p-5">
                ...
                <form action="../action.php" method="post" enctype="multipart/form-data">
                    ...
                    <hr />
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary float-right radius-30 btn-lg" name="add_new_discount_banner">Submit</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-body">
                <div class="row justify-content-center">
                    <div class="col-md-12 py-4 px-2">
                        <img id="view_image" src="" class="w-100 card-img-top" alt="">
                        <h2 class="text-primary ">Banner Title: </h2>
                        <h5 class="card-title " id="view_title"></h5>
                        <h2 class="text-primary ">Status: </h2>
                        <h5 class="card-title ">
                            <div class=" badge badge-glow badge-pill badge-warning" id="view_status1"></div>
        ...
        <div class="modal-content radius-30">
            ...
            <div class="modal-body p-5">
                ...
                <form action="../action.php" method="post" enctype="multipart/form-data">
                    ...
                    <hr />
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary float-right  btn-lg " name="edit_discount_banner">Update Card Banner</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-body">
                <form action="../action.php" method="POST">
                    ...
                    <div class="modal-footer border-top-0">
                        ...
                        <button type="submit" name="delete_discount_banner" class="btn btn-outline-danger">Delete</button>
                    </div>
                </form>
            </div>
