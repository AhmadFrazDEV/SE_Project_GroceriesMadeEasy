                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-title">
                            <h2 class="mb-0 text-center h1 text-primary uppercase">Pending Orders</h2>
                        </div>
                        <hr>
                                        ...
                                        <td>
                                            <div class="col-lg-6 col-12">
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <a data-toggle="popover"  data-trigger="hover" data-original-title="Paid Order"  class="btn btn-linkedin"><i class=" fas fa-money-bill-wave-alt"></i></a>
                                                    </span>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content radius-30">
            <div class="modal-header bg-info border-bottom-0">
                <h4 class="modal-title my-1" >Paid Order</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body p-5">
                ...
                <form action="../action.php" method="post" enctype="multipart/form-data">
                    ...
                    <hr/>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary float-right  btn-lg " name="order_paid">Paid Order</button>
                    </div>
                </form>
            </div>
        </div>
