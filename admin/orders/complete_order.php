                    ...
                    <div class="d-flex justify-content-between breadcrumb-wrapper">
                        <nav aria-label="breadcrumb ">
                            <ol class="breadcrumb mt-2">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Completed Orders</a></li>
...
<div class="card">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-title">
                            <h2 class="mb-0 text-center h1 text-primary uppercase">Completed Orders</h2>
                        </div>
                        <hr>
                                        ...
                                        <td>
                                            <div class="col-lg-6 col-12">
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <button data-toggle="popover"  data-trigger="hover" data-original-title="View Order Detail" type="button" class="btn btn-linkedin" ><i class="fa fa-eye" ></i></button>
                                                    </span >
 ...
 <div class="col-12">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="delete-sub_category<?php echo $sub_category['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content  border-0">
                                                <div class="modal-header bg-danger bg-darken-2 border-bottom-0">
                                                    <h5 class="modal-title" style="color:white;">Delete Sub Category</h5>
                                                ...
                                                <form action="action.php" method="POST">
                                                    ...
                                                    <input type="text" name="delete_id" value="<?php echo $sub_category['id'];?>" hidden>
                                                    <div class="modal-footer border-top-0">
                                                        <button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
                                                        <a href="action.php?delete_sub_category=<?php echo $sub_category['id'];?>" class="btn btn-outline-danger">Delete</a>
                                                    </div>
