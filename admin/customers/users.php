...
<script type="text/javascript">
    ...
    if(status==1)
    {
        swal({
            ...
            const nextURL = 'https://dev.single-solution.com/gme/admin/customers/users.php';
            const nextTitle = '';
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-title">
                            <h2 class="mb-0 text-center h1 text-primary uppercase">Customers</h2>
                        </div>
                        <hr>
                            ...
                            if($status==0){
                                            ...
                                            <td class="text-center ">
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                     <span onclick="edit_status('<?php echo $user['id']; ?>','<?php echo $user['status']; ?>')">
                                                    <a   data-toggle="popover"  data-trigger="hover" data-original-title="Edit Access"   class="btn btn-linkedin "><i class=" fas fa-user-edit"></i></a>
                                                    </span>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content radius-30">
            <div class="modal-header bg-info border-bottom-0">
                <h4 class="modal-title my-1" >Edit Access</h4>
