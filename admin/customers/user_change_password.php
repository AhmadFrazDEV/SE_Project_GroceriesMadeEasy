...
<script type="text/javascript">
    ...
    if(status==1)
    {
        swal({
            ...
            const nextURL = 'https://dev.single-solution.com/kids_clothing/admin/user_change_password.php';
            const nextTitle = '';
    ...
    if(status==5)
    {
        swal({
            ...
            // Current URL: https://my-website.com/page_a
            const nextURL = 'https://dev.single-solution.com/kids_clothing/admin/category.php';
            const nextTitle = '';
            const nextState = { additionalInformation: '' };
