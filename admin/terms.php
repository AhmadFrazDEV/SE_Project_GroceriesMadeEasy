...
<script type="text/javascript">
    ...
    if(status==1)
    {
        swal({
            ...
            const nextURL = 'https://dev.single-solution.com/gme/admin/terms.php';
            const nextTitle = '';
...
<h2 class="mb-0 text-center h1 text-primary uppercase">Terms And Privacy</h2>
<hr>
<div class="row">
    <?php
    if($term!=NULL)
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p style="  overflow:hidden;
                          ...
                          -webkit-line-clamp: 4;"> <?php echo $term['description']; ?></p>
                <hr>
                <div class="profile-social mt-3 text-right">
                    <span  onclick="view()">
                    <a data-toggle="popover"  data-trigger="hover" data-original-title="View Detail"  class="btn btn-linkedin text-center bg-success bg-darken-2  text-white  float-left" ><i class="fa fa-eye "></i></a>
                    </span>
                    <span onclick="edit()">
                    <a data-toggle="popover"  data-trigger="hover" data-original-title="Edit Detail"  class="btn btn-linkedin " ><i class="bx bx-edit"></i></a>
                    </span>
                    <!--

<a class="btn btn-pinterest " onclick="delete_banner('<?php echo $term['id']; ?>')"><i class="bx bx-trash"></i></a>
-->
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title  my-1" >View Term & Privacy Details</h4>
            ...
            <div class="modal-body">
                <div class="row justify-content-center">
                    <div class="col-md-12 py-4 px-2">
                        ...
                        <h2 class="text-primary ">Description: </h2>
                        <h5 class="card-title " id="view_title"><?php echo $term['description']; ?></h5>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content radius-30">
            <div class="modal-header bg-info border-bottom-0">
                <h4 class="modal-title my-1" >Edit Term & Privacy Details</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body p-5">
                ...
                <form action="action.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="edit_title" name="edit_description"  class="form-control form-control-lg radius-30" ><?php echo $term['description']; ?></textarea>
                    </div>

                    <input type="text" id="edit_id" name="edit_id" value="<?php echo $term['id']; ?>" hidden>
                    <hr/>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary float-right  btn-lg " name="edit_terms">Update</button>
                    </div>
                </form>
            </div>
        </div>
