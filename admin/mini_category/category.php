    ...
    <div class="col-12 col-lg-3 col-xl-3" >
        <div class="card">
            ...
            if($user_role=='1'){
                    ...
                    <a   class="btn btn-linkedin " onclick="edit('<?php echo $category['id']; ?>','<?php echo $category['c_name']; ?>')"><i class="bx bx-edit"></i></a>

                    <a class="btn btn-pinterest " onclick="delete_modal('<?php echo $category['id']; ?>')"><i class="bx bx-trash"></i></a>
                    <?php
            }
                    ?>
                </div>
