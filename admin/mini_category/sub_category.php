                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between breadcrumb-wrapper">
                        ...
                        <nav aria-label="breadcrumb ">
                            <div class="ml-auto">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-success bg-success bg-darken-2 m-1 px-5" data-toggle="modal" data-target="#add"><i class="bx bx-image-add mr-1"></i>Add Sub Category</button>
                                </div>
                            </div>
                        </nav>
                        <?php
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-title">
                            <h2 class="mb-0 text-center h1 text-primary uppercase">Sub Categories</h2>
                        </div>
                        <hr>
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        ...
                                        <td class="text-center table-active">
                                            ...
                                            <a   class="btn btn-linkedin " onclick="edit('<?php echo $sub_category['id']; ?>','<?php echo $sub_category['sc_name']; ?>','<?php echo $categories_record['id']; ?>')"><i class="bx bx-edit"></i></a>

                                            <a class="btn btn-pinterest " onclick="delete_modal('<?php echo $sub_category['id']; ?>')"><i class="bx bx-trash"></i></a>
                                        </td>
                                        <?php
                                            }
                                        ?>
...
<script type="text/javascript">
    ...
    if(status==1)
    {
        swal({
            ...
            const nextURL = 'https://dev.single-solution.com/gme/admin/sub_category.php';
            const nextTitle = '';
