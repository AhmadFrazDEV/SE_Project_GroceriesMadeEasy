...
<script type="text/javascript">
    ...
    if(status==1)
    {
        swal({
            ...
            const nextURL = 'https://dev.single-solution.com/gme/admin/video.php';
            const nextTitle = '';
...
<h2 class="mb-0 text-center h1 text-primary uppercase">Active Video</h2>
<hr>
<div class="row">
    <?php
    if($videos!=NULL)
    ...
    <div class="col-12 col-lg-6 col-xl-6" >
        <div class="card">
            ...
            {
                ?>
                <div class="video-player mb-4" id="plyr-video-player">
                    <video class="w-100" height="240" controls>

                        <source  src="<?php echo "files/videos/".$video['video_name']; ?>"  >
            ...
            if($video['url']!=NULL){
                ...
                <iframe class="w-100 mb-4" height="240" controls
                ...
                <h2>Title: <?php echo $video['title']; ?></h2>
                <hr>
                <div class="profile-social mt-3 text-right">
                    <!--                    <a onclick="view('<?php echo $video['title']; ?>','<?php echo "files/videos/".$video['video_name']; ?>')"  class="btn btn-linkedin text-center bg-success bg-darken-2  text-white  float-left" ><i class="fa fa-eye "></i></a>-->
                    <span onclick="edit('<?php echo $video['id']; ?>','<?php echo $video['title']; ?>','<?php echo $video['url']; ?>')">
                    <a data-toggle="popover"  data-trigger="hover" data-original-title="Edit Video"  class="btn btn-linkedin " ><i class="bx bx-edit"></i></a>
                    </span>
                    <span onclick="delete_banner('<?php echo $video['id']; ?>')">
                    <a data-toggle="popover"  data-trigger="hover" data-original-title="Delete Video" class="btn btn-pinterest " ><i class="bx bx-trash"></i></a>
                    </span>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title  my-1" >View Video Details</h4>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content radius-30">
            <div class="modal-header bg-info border-bottom-0">
                <h4 class="modal-title my-1" >Edit Video Details</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body p-5">
                ...
                <form action="action.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="h4">Url</label>
                        <input type="url" id="edit_url" name="edit_url"  class="form-control form-control-lg radius-30" />
                    </div>
                    ...
                    <hr/>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary float-right  btn-lg " name="edit_video">Update Video</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content  border-0">
            <div class="modal-header bg-danger bg-darken-2 border-bottom-0">
                <h5 class="modal-title" style="color:white;">Delete Video</h5>
