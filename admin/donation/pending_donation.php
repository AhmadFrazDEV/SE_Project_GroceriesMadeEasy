                    ...
                    <div class="d-flex justify-content-between breadcrumb-wrapper">
                        <nav aria-label="breadcrumb ">
                            <ol class="breadcrumb mt-2">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Pending Donations</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-title">
                            <h2 class="mb-0 text-center h1 text-primary uppercase">Pending Donations</h2>
                        </div>
                        <hr>
                                        ...
                                        <td>
                                            <div class="col-lg-6 col-12">
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <button data-toggle="popover"  data-trigger="hover" data-original-title="View Donation Detail" type="button" class="btn  btn-success bg-success bg-darken-2"  ><i class="fa fa-eye" ></i></button>
                                                    </span>
                                                    <span onclick="edit('<?php echo $donation['donate_id']; ?>')">
                                                    <a data-toggle="popover"  data-trigger="hover" data-original-title="Paid Donation"   class="btn btn-linkedin"><i class=" fas fa-money-bill-wave-alt"></i></a>
                                                    </span>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content radius-30">
            <div class="modal-header bg-info border-bottom-0">
                <h4 class="modal-title my-1" >Paid Donation</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body p-5">
                ...
                <form action="../action.php" method="post" enctype="multipart/form-data">
                    <p class="text-primary" >Are You Sure to Paid This</p>
                    <input type="text" id="edit_id" name="edit_id" value="" hidden>
                    <hr/>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary float-right  btn-lg " name="donation_paid">Paid Donation</button>
                    </div>
                </form>
            </div>
        </div>
