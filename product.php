                                ...
                                ?>
                                    <div class="product-inner">
                                        <div class="thumb">
                                            ...
                                            <a href="productdetail.php?id=<?php echo $product['id']; ?>" class="image">
                                            ...
                                            <div class="actions">
                                                <a onclick="add_product_to_wishlist('<?php echo $product['id']; ?>')" title="Wishlist" class="action wishlist"><i class="pe-7s-like"></i></a>
                                            </div>
                                        </div>
                                        <div class="content">
                                            <h4 class="sub-title"><a href="categorized_product.php?id=<?php echo $category['id']; ?>"><?php echo $category['c_name']; ?></a></h4>
                                            <h5 class="title"><a href="productdetail.php?id=<?php echo $product['id']; ?>"><?php echo $product['name']; ?></a></h5>
                                            ...
                                            <a href="productdetail.php?id=<?php echo $product['id']; ?>" class="btn btn-sm btn-outline-dark btn-hover-primary">Buy</a>
                                        </div>
                                    </div>
